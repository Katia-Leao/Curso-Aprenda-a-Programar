...
for (var i = 0; i < receita.length; i++){
    faturamento += receita[i].valor
} 
console.log(`o total de vendas sem as gorjetas é R$${faturamento}`)
...
for (var i = 0; i < receita.length; i++){
    gorjetas += receita[i].gorjeta
} 
console.log(`o total recebido incluindo as gorjetas é R$${gorjetas + faturamento}`)
...
} console.log (`o número de vendas abaixo de R$50 foi ${positivo}`);
